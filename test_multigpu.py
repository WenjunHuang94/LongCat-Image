...
def parse_args():
    parser = argparse.ArgumentParser(description="Multi-GPU inference for LongCat-Image-Edit")
    ...
    parser.add_argument(
        ...
        help="Base LongCat-Image-Edit model path (local directory).",
    )
    parser.add_argument(
        "--lora_path",
        type=str,
    ...
    parser.add_argument(
        "--output_image",
        type=str,
        default="./edit_example_multigpu.png",
...
if __name__ == '__main__':
    ...
    # 1. 加载基础 transformer 到 CPU（后面再做 model parallel）
